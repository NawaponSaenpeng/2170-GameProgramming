...
{
    public ParticleSystem dustParti;
    public ParticleSystem deathParti;
    public ParticleSystem groundParti;
    ...
    private void Move()
    {
        ...
        if (_isGrounded && rb.velocity.x != 0)
        {
            PlayDust();
        }
    }
